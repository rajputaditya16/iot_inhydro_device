...
# Channel 3 (Physical Relay 4) assigned to Fogger Sync ACF Relay
relay_acf_sync   = ModbusRelay(3, "ACF Fogger Sync")
...
def all_relays_off():
    for r in [relay_ec1, relay_ec2, relay_ph, relay_acf_sync, relay_fan1, relay_fan2, relay_pad, relay_fogger, relay_acf, relay_sprinkler, relay_irrigation, relay_timer1, relay_timer2, relay_solenoid]:
        try: r.off()
        except: pass
